...
from controllers.common.hnuter_attitude_control import (
...
from controllers.common.hnuter_log_paths import configure_ros_log_dir, diagnostic_csv_path
...
class HnuterController(Node):
    def __init__(self):
        ...
        self.tuning_path = os.path.expanduser(os.environ.get(
            'HNUTER_TUNING_FILE',
            str(Path(__file__).resolve().parents[2] / 'config/simulation/hnuter_direct_tuning.json'),
        ))
