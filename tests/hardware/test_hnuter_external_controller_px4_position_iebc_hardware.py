...
from controllers.hardware import hnuter_external_controller_px4_position_iebc_hardware as module
from controllers.hardware.hnuter_external_controller_px4_position_hardware import HnuterController
from controllers.hardware.hnuter_external_controller_px4_position_iebc_hardware import (
...
def test_simulation_and_hardware_embed_the_same_iebc_core():
    from controllers.simulation.hnuter_external_controller_px4_position_iebc_simulation import (
