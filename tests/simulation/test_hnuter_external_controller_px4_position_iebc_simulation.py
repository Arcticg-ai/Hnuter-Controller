...
def test_recovery_log_columns_are_present_and_aligned():
    ...
    source = (
        ...
        / 'controllers/simulation/hnuter_external_controller_px4_position_iebc_simulation.py'
    )
...
def test_simulation_contains_closed_loop_controller():
    from controllers.simulation import hnuter_external_controller_px4_position_iebc_simulation as experiment

    assert experiment.HnuterIebcSimulationController.__module__ == (
        'controllers.simulation.hnuter_external_controller_px4_position_iebc_simulation'
    )
